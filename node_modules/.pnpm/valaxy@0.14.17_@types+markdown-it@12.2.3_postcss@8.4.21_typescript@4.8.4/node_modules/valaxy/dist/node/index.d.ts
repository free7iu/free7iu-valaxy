...
import { D as DefaultThemeConfig, V as ValaxyConfig, P as PartialDeep, a as ValaxyAddon, R as RuntimeConfig, U as UserSiteConfig, S as SiteConfig } from '../config-6ba89780.js';
...
declare type ValaxyNodeConfig<ThemeConfig = DefaultThemeConfig> = ValaxyConfig<ThemeConfig> & ValaxyExtendConfig;
declare type UserValaxyNodeConfig<ThemeConfig = DefaultThemeConfig> = PartialDeep<ValaxyNodeConfig<ThemeConfig>>;
/**
 * fn with options for theme config
 */
declare type ValaxyConfigFn<ThemeConfig = DefaultThemeConfig> = (options: ResolvedValaxyOptions<ThemeConfig>) => ValaxyNodeConfig | Promise<ValaxyNodeConfig>;
declare type ValaxyConfigExport<ThemeConfig = DefaultThemeConfig> = ValaxyNodeConfig<ThemeConfig> | ValaxyConfigFn<ThemeConfig>;
...
declare type ValaxyAddons = (ValaxyAddon | string)[] | Record<string, ValaxyAddonLike>;
declare type ValaxyAddonFn<ThemeConfig = DefaultThemeConfig> = (addonOptions: ValaxyAddonResolver, valaxyOptions: ResolvedValaxyOptions<ThemeConfig>) => ValaxyNodeConfig | Promise<ValaxyNodeConfig>;
declare type ValaxyAddonExport<ThemeConfig = DefaultThemeConfig> = ValaxyNodeConfig<ThemeConfig> | ValaxyAddonFn<ThemeConfig>;
 ...
 * @returns
 */
declare function resolveThemeValaxyConfig(options: ResolvedValaxyOptions): Promise<ValaxyNodeConfig<DefaultThemeConfig>>;
 ...
 * @param options
 */
declare const postProcessForSSG: (options: ResolvedValaxyOptions) => Promise<void>;
...
declare type ValaxyPickConfig = Pick<ValaxyNodeConfig, ValaxyConfigExtendKey>;
...
declare function resolveValaxyConfigFromRoot(root: string, options?: ResolvedValaxyOptions): Promise<{
    config: ValaxyNodeConfig<DefaultThemeConfig>;
    configFile: string;
}>;
/**
...
declare function resolveAddonConfig(addons: ValaxyAddonResolver[], options?: ResolvedValaxyOptions): Promise<ValaxyNodeConfig<DefaultThemeConfig>>;
 ...
 * @returns
 */
declare const transformObject: (obj: any) => string;
